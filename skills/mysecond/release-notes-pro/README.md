...
1. Unzip this file
2. Move the `release-notes-pro` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `release-notes-pro` folder to `~/.claude/skills/`
...
- Tiered versions (T1 major, T2 medium, T3 minor)
- Multi-channel formats (changelog, email, in-app, social)
...
→ [Full documentation](https://mysecond.ai/skills/release-notes-pro)
