...
1. Unzip this file
2. Move the `board-deck-generator` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `board-deck-generator` folder to `~/.claude/skills/`
...
- Board deck outline (10-12 slides)
- Narrative flow with talking points
...
→ [Full documentation](https://mysecond.ai/skills/board-deck-generator)
