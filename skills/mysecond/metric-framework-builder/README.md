...
1. Unzip this file
2. Move the `metric-framework-builder` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `metric-framework-builder` folder to `~/.claude/skills/`
...
- North Star + input metrics hierarchy
- AARRR or HEART framework applied
- Guardrail metrics defined
- Review cadence established
- Team alignment on what matters
- Dashboard-ready definitions

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/metric-framework-builder)
