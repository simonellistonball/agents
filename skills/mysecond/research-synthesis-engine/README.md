...
1. Unzip this file
2. Move the `research-synthesis-engine` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `research-synthesis-engine` folder to `~/.claude/skills/`
...
- Theme clustering with evidence strength
- Convergence and contradiction analysis
- Research gaps identified
- Prioritized opportunity list
- Atomic insight database

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/research-synthesis-engine)
