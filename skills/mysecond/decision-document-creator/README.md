...
1. Unzip this file
2. Move the `decision-document-creator` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `decision-document-creator` folder to `~/.claude/skills/`
...
- Analysis with data and research
- Implementation plan
- Revisit triggers
...
→ [Full documentation](https://mysecond.ai/skills/decision-document-creator)
