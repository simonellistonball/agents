...
1. Unzip this file
2. Move the `prioritization-engine` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `prioritization-engine` folder to `~/.claude/skills/`
...
- RICE/ICE scoring with transparent calculations
- Detailed breakdown per item
- Value/effort matrix visualization
- Sensitivity analysis
- Strategic override documentation
- Stakeholder-ready reasoning

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/prioritization-engine)
