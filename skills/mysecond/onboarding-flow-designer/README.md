...
1. Unzip this file
2. Move the `onboarding-flow-designer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `onboarding-flow-designer` folder to `~/.claude/skills/`
...
- Metrics and A/B test plan

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/onboarding-flow-designer)
