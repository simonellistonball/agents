...
1. Unzip this file
2. Move the `competitive-profile-builder` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `competitive-profile-builder` folder to `~/.claude/skills/`
...
- DHM analysis (Delight, Hard-to-Copy, Margin)
- SWOT breakdown
- Head-to-head comparison table
- Win/loss scenarios
- Sales battle card content
- Sourced and dated for credibility

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/competitive-profile-builder)
