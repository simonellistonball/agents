...
1. Unzip this file
2. Move the `roadmap-builder` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `roadmap-builder` folder to `~/.claude/skills/`
...
- Structured roadmap with strategic themes
- Now/Next/Later prioritization
- Dependencies and risks identified
- Success metrics for the period
...
→ [Full documentation](https://mysecond.ai/skills/roadmap-builder)
