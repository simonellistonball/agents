...
1. Unzip this file
2. Move the `build-vs-buy-analyzer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `build-vs-buy-analyzer` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/build-vs-buy-analyzer)
