...
1. Unzip this file
2. Move the `customer-voice-reviewer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `customer-voice-reviewer` folder to `~/.claude/skills/`
...
- Per-persona assessment (excited / lukewarm / resistant)
- Adoption likelihood with barriers identified
- Support burden estimate (ticket volume, documentation needs)
- Customer Success perspective on churn and satisfaction impact
- What users will love and what they'll struggle with
...
→ [Full documentation](https://mysecond.ai/skills/customer-voice-reviewer)
