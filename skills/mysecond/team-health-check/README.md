...
1. Unzip this file
2. Move the `team-health-check` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `team-health-check` folder to `~/.claude/skills/`
...
- Health indicators with ratings
- What is going well (themes)
- What needs attention (with severity)
- Deep dives on top concerns
...
→ [Full documentation](https://mysecond.ai/skills/team-health-check)
