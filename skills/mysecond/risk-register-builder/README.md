...
1. Unzip this file
2. Move the `risk-register-builder` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `risk-register-builder` folder to `~/.claude/skills/`
...
- V/U/F/V risk identification (Value, Usability, Feasibility, Viability)
...
→ [Full documentation](https://mysecond.ai/skills/risk-register-builder)
