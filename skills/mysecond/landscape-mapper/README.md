...
1. Unzip this file
2. Move the `landscape-mapper` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `landscape-mapper` folder to `~/.claude/skills/`
...
- Watch list for emerging threats

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/landscape-mapper)
