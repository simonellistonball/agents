...
1. Unzip this file
2. Move the `north-star-finder` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `north-star-finder` folder to `~/.claude/skills/`
...
- North Star candidate evaluation
- Scoring against 5 criteria (value, leading, actionable, simple, not gameable)
...
→ [Full documentation](https://mysecond.ai/skills/north-star-finder)
