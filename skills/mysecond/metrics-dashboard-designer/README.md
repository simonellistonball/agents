...
1. Unzip this file
2. Move the `metrics-dashboard-designer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `metrics-dashboard-designer` folder to `~/.claude/skills/`
...
- Metrics definitions with targets
...
→ [Full documentation](https://mysecond.ai/skills/metrics-dashboard-designer)
