...
1. Unzip this file
2. Move the `app-review-analyzer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `app-review-analyzer` folder to `~/.claude/skills/`
...
- Sentiment overview with trends
...
→ [Full documentation](https://mysecond.ai/skills/app-review-analyzer)
