...
1. Unzip this file
2. Move the `ab-test-analyzer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `ab-test-analyzer` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/ab-test-analyzer)
