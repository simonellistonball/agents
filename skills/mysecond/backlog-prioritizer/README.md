...
1. Unzip this file
2. Move the `backlog-prioritizer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `backlog-prioritizer` folder to `~/.claude/skills/`
...
- Low confidence risks flagged

---

## Learn More

→ [Full documentation](https://mysecond.ai/skills/backlog-prioritizer)
