...
1. Unzip this file
2. Move the `executive-update-generator` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `executive-update-generator` folder to `~/.claude/skills/`
...
- SCARF-structured update (Status, Context, Action, Risks, Forward)
- TL;DR that leads with the punchline
...
→ [Full documentation](https://mysecond.ai/skills/executive-update-generator)
