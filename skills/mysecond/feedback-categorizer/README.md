...
1. Unzip this file
2. Move the `feedback-categorizer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `feedback-categorizer` folder to `~/.claude/skills/`
...
- Theme extraction with frequency counts
- Sentiment analysis (positive/negative/neutral)
- Urgency scoring
- Representative quotes preserved
...
→ [Full documentation](https://mysecond.ai/skills/feedback-categorizer)
