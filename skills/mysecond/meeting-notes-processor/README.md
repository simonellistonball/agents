...
1. Unzip this file
2. Move the `meeting-notes-processor` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `meeting-notes-processor` folder to `~/.claude/skills/`
...
- Decisions extracted with owners and scope
...
→ [Full documentation](https://mysecond.ai/skills/meeting-notes-processor)
