...
1. Unzip this file
2. Move the `process-documentation` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `process-documentation` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/process-documentation)
