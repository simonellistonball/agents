...
1. Unzip this file
2. Move the `quarterly-planning-template` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `quarterly-planning-template` folder to `~/.claude/skills/`
...
- What we are NOT doing (with rationale)
...
→ [Full documentation](https://mysecond.ai/skills/quarterly-planning-template)
